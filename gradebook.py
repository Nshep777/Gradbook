...
class Gradebook(ttk.Frame):
    ...
    def create_table(self):
        ...
        rowdata = [[entry["Name"], entry["Student ID"], entry["Course Name"], entry["Final Score"]] for entry in self.data]
    ...
    def on_edit(self):
        select = self.table.get_selected_row()
    ...
    def on_submit(self):
        ...
        self.data.append({"Name": name, "Student ID": student_id, "Course Name": course_name, "Final Score": final_score})
    ...
    def save_data_to_json(self):
        ...
        with open('gradebook_data.json', 'w') as file:
            json.dump(self.data, file)

    def load_data_from_json(self):
        """Load data from a JSON file."""
        try:
            with open('gradebook_data.json', 'r') as file:
                self.data = json.load(file)
        except FileNotFoundError:
            # File not found, no worries, start with an empty list
            self.data = []
        

if __name__ == "__main__":

    app = ttk.Window("Gradebook", "minty", resizable=(False, False))
    Gradebook(app)
    app.mainloop()